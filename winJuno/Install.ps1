$serviceName = "WinJunoService" 
$serviceDisplayName = "WinJuno Service" 
$serviceDescription = "This service controls all the Oberon Devices at my house" 
$serviceExecutable = "WinJuno.exe"
